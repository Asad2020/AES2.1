...
//@View(members="")
@Tab(properties="customerForecast.customer.name, customerForecast.monthYear.monthYear, "
		+ "customerForecast.workingDay, carModelVariance.carModel.carModel, "
		+ "carModelVariance.carModelVariance, estimatedQuantity")
